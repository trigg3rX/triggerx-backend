...
// Client handles gRPC notification delivery
type Client struct {
	logger observability.Logger
	tracer observability.Tracer
}

// NewClient creates a new gRPC notification client
...
func (c *Client) Send(ctx context.Context, serviceURL string, notification *types.EventNotification) error {
