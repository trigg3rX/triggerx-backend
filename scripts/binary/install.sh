...
#   this=$1
#   cat <<EOF
# $this: download go binaries for trigg3rX/triggerx-backend
...
#    [tag] is a tag from
#    https://github.com/trigg3rX/triggerx-backend/releases
...
# get_binaries() {
#   case "$PLATFORM" in
#     darwin/amd64) BINARIES="triggerx" ;;
#     darwin/arm64) BINARIES="triggerx" ;;
#     linux/amd64) BINARIES="triggerx" ;;
#     linux/arm64) BINARIES="triggerx" ;;
#     *)
...
# PROJECT_NAME=triggerx-backend
# OWNER=trigg3rX
# REPO="triggerx-backend"
# BINARY=triggerx
# FORMAT=tar.gz
# OS=$(uname_os)
# ARCH=$(uname_arch)
...
#       sed_in_place "/.*# triggerx completion/d" $BASH_COMPLETION_MAIN
#       echo "source $BASH_COMPLETION_SCRIPT_PATH # triggerx completion" >> $BASH_COMPLETION_MAIN
#       if [ "$(uname)" = Darwin ]
#       then
#         HAS_BREW=false
...
#             BASHRC=~/.bashrc
#             touch $BASHRC
#             sed_in_place "/.*# triggerx completion/d" $BASHRC
#             echo "source $(brew --prefix)/etc/bash_completion # triggerx completion" >> $BASHRC
#           else
#             echo "warning: brew bash-completion package not found. triggerx command completion for bash not installed"
#           fi
#         else
#           echo "warning: brew not found. triggerx command completion for bash not installed"
#         fi
#       fi
#     else
#       echo "warning: auto completion generation command failed. triggerx command completion for bash not installed"
#     fi
#   fi
...
#       echo "fpath=($ZSH_COMPLETION_SCRIPTS_DIR \$fpath) # triggerx completion" >> $ZSH_COMPLETION_MAIN
#       echo "rm -f ~/.zcompdump; compinit # triggerx completion" >> $ZSH_COMPLETION_MAIN
#     else
#       echo "warning: auto completion generation command failed. triggerx command completion for zsh not installed"
#     fi
#   fi
# }
