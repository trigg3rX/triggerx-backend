...
| ----------------- | -------------------------------------------------- | ------------------------------------- |
| **Alchemy RPC**   | DBServer, Condition Scheduler, Keeper, TaskMonitor | EVM chain interactions                |
| **Blast RPC**     | (Alternative to Alchemy)                           | EVM chain interactions                |
| **Pinata/IPFS**   | DBServer, Keeper, TaskMonitor                      | Script storage and retrieval          |
| **Etherscan**     | Keeper                                             | Contract ABI fetching, gas estimation |
| **Telegram**      | Health Service                                     | Alert notifications                   |
| **Upstash Redis** | Condition Scheduler, TaskDispatcher, TaskMonitor   | Cloud Redis alternative               |
...
_Generated from analysis of [triggerx-backend](https://github.com/trigg3rX/triggerx-backend) project structure_
