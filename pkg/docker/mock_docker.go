...
// Source: ./pkg/docker/interface.go
...
func (m *MockDockerExecutorAPI) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockDockerExecutorAPIMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockDockerExecutorAPI)(nil).Close))
}
