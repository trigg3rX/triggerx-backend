...
// Package dockerexecutor is a generated GoMock package.
...
import (
	...
	config "github.com/trigg3rX/triggerx-backend/pkg/dockerexecutor/config"
...
func (m *MockDockerExecutorAPI) Execute(ctx context.Context, fileURL, fileLanguage string, noOfAttesters int, alchemyAPIKey string, metadata ...map[string]string) (*types.ExecutionResult, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, fileURL, fileLanguage, noOfAttesters, alchemyAPIKey}
...
func (mr *MockDockerExecutorAPIMockRecorder) Execute(ctx, fileURL, fileLanguage, noOfAttesters, alchemyAPIKey interface{}, metadata ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, fileURL, fileLanguage, noOfAttesters, alchemyAPIKey}, metadata...)
