...
require (
	...
	github.com/trigg3rX/imua-contracts/bindings v0.0.0-20250730063129-fea6db152d95
	github.com/trigg3rX/triggerx-contracts/bindings v0.0.0-20250828063447-f59a8a19b2a2
